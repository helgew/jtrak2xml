...
(1.0-alpha-4-SNAPSHOT)](https://github.com/helgew/jtrak2xml/releases/download/jtrak2xml-1.0-alpha-4-SNAPSHOT/jtrak2xml.1.0-alpha-4-SNAPSHOT.jar)
...
```
java -jar ~/Downloads/jtrak2xml.1.0-alpha-4-SNAPSHOT.jar
```
